...
export default {
  'en-us': {
    brand: {
      brandName: 'Integrated Maritime Management',
  ...
  'zh-cn': {
    brand: {
      brandName: 'Integrated Maritime Management',
      briefIntroduction: '成为客户最为信赖的合作伙伴，提供最优秀的全方位综合海事服务',
      buttons: [
        {
          text: '联系我们',
      ...
      list1: [
        {
          img: '/img/service_tech.jpg',
          title: '技术管理',
          content: '凭借我们的资源和经验，我们有能力在技术上管理各种不同的货船。IMM 持有劳氏船级社 （LR） 代表各船旗国签发的合规文件 （DoC）',
        },
        {
          img: '/img/service_quality.jpg',
          title: '质量管理',
      ...
      list2: [
        {
          img: '/img/service_commercial.jpg',
          title: '商务管理',
          content: '凭借我们在行业中的人脉以及公司内部的专业知识和资源，我们能够为客户的船舶进行商务上的操作和管理。',
        },
        {
          img: '/img/service_crew.jpg',
          title: '船员管理',
      ...
      list3: [
        {
          img: '/img/service_insurance.jpg',
          title: '保险',
          content: '我们凭借丰富的内部知识和经验，能够有效的管控航运行业的风险。我们的保险服务包括船体和机械、货运、滞期和防护（FD&D）、船员、货物和一般平均水平、财产损失、污染、雇佣损失、战争风险、沉船清除、MLC下的责任、新建筑风险等',
        },
        {
          img: '/img/service_supervision.jpg',
          title: '新造船监管',
